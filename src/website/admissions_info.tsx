          ...
          <div className="p-6 space-y-8">
            ...
            <div>
              <p className="text-gray-700 leading-relaxed">
                At Riser School, we are passionate about providing an
                outstanding education that nurtures, inspires, and empowers
                every student. From our warm and inclusive community to our
                world-class facilities, we offer a learning experience like no
                other. Admissions for the new academic year are now open! This
                is your chance to give your child a head start toward a bright
                future.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Our passionate and highly qualified teachers are committed
                    to bringing out the best in every child, fostering a love
                    for learning and personal excellence.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    melting pot of cultures, preparing children for a future in
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    boarding facilities are safe, nurturing, and truly feel like
            ...
            <div>
              ...
              <p className="text-gray-700 mb-4">
                At Riser School, we strive to make the admissions process
                seamless for families. Here's how it works:
              </p>
              <div className="space-y-4">
                <div>
                  <h4 className="font-medium text-gray-800 mb-2">
                  ...
                  <p className="text-gray-700">
                    Contact us to schedule a school tour. See our facilities,
                    meet our teachers, and experience firsthand what makes Riser
                    so special.
                  </p>
                </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>
                    <strong>Secondary School (Year 7-11):</strong> Ages 11–18
                    (Key Stage 3, Key Stage 4, and IGCSE)
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <p className="text-blue-800 mb-4">
                ...
                you'll make as a parent. At Riser School, we partner with
                families to unlock every child's potential and prepare them for
